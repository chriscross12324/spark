...
class MetricOxygenModuleWidgetBackup extends StatefulWidget {
  const MetricOxygenModuleWidgetBackup({super.key});

  @override
  State<MetricOxygenModuleWidgetBackup> createState() => _MetricOxygenModuleWidgetState();
}

class _MetricOxygenModuleWidgetState extends State<MetricOxygenModuleWidgetBackup> with AutomaticKeepAliveClientMixin {
