...
class DialogModifyValue extends ConsumerWidget {
  const DialogModifyValue({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final textEditingController = TextEditingController(text: currentValue);
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomTextField(
                title: 'New Value',
                description:
                    'Submitting will replace the value for \'$valueName\'.',
                hintText: '',
